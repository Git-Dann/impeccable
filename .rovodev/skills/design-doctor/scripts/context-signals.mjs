#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare Design Doctor invocation
 ...
 * light: no LLM calls, no detector run (`npx design-doctor detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.design-doctor/critique)
...
import { getCritiqueDir } from './lib/design-doctor-paths.mjs';
