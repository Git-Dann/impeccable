...
```bash
node .opencode/skills/design-doctor/scripts/detect.mjs --json --scope layout [target files or dirs]
```
...
When the rhythm and hierarchy land, hand off to `/design-doctor polish` for the final pass.
