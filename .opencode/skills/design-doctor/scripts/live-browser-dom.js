/**
 * Browser-side DOM helpers for Design Doctor live mode.
 *
...
(function (root) {
  ...
  function createLiveBrowserDomHelpers({
    ...
    function makeFrozenAnchor(el) {
      ...
      return {
        __designDoctorFrozenAnchor: true,
    ...
    function liveUiRoot() {
      const uiRoot = root.__DESIGN_DOCTOR_LIVE_UI_ROOT__;
  ...
  root.__DESIGN_DOCTOR_LIVE_DOM__ = {
    version: 1,
