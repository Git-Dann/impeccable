/**
 * Browser-side durable session helpers for Design Doctor live mode.
 *
 ...
 * window.__DESIGN_DOCTOR_LIVE_SESSION__.
 */
(function (root) {
  'use strict';
  ...
  root.__DESIGN_DOCTOR_LIVE_SESSION__ = { createLiveBrowserSessionState };
