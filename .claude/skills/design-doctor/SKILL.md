...
allowed-tools:
  ...
  - Bash(node .claude/skills/design-doctor/scripts/*)
---
...
```bash
node .claude/skills/design-doctor/scripts/pin.mjs <pin|unpin> <command>
```
