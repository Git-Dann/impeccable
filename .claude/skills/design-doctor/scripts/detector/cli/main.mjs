...
function printUsage() {
  console.log(`Usage: design-doctor detect [options] [file-or-dir-or-url...]
...
Options:
  ...
  --no-inline-ignores Do not honor in-file design-doctor-disable* ignore comments
  --no-design-system  Do not load local DESIGN.md / .design-doctor/design.json context
  --help              Show this help message

Project config:
  Respects .design-doctor/config.json and .design-doctor/config.local.json detector
  settings: detector.ignoreRules, detector.ignoreFiles, detector.ignoreValues,
  and detector.designSystem.enabled.

Inline ignores:
  In-file comments waive a finding where it lives and travel with the file:
    <!-- design-doctor-disable overused-font -- exported brand doc -->
    .brand { font-family: Inter } /* design-doctor-disable-line overused-font */
    // design-doctor-disable-next-line bounce-easing: intentional bounce
  design-doctor-disable applies to the whole file; -line / -next-line are scoped.
...
Examples:
  design-doctor detect src/
  design-doctor detect index.html
  design-doctor detect https://example.com
  design-doctor detect --json .
  design-doctor detect --no-config src/`);
}
...
async function detectCli() {
  ...
  // Inline `design-doctor-disable*` waivers are part of the scanned file, so they
            ...
            if (fwConfig) {
              ...
              if (probe.listening && probe.matched) {
                process.stderr.write(
                  ...
                  `  npx design-doctor detect http://localhost:${fwConfig.port}\n\n`
                );
